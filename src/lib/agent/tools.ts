...
const markdownField = (what: string) =>
  z.string().max(50_000).describe(
    `${what} as markdown: # h1-###### h6, paragraphs, - bullets, 1. numbered lists, [CTA label](url) on its own line for buttons, <!--eyebrow--> line before a short overline`,
  );
